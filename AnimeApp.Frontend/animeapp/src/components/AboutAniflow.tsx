...
export default function AboutAniflow() {
    ...
    return (
        <div>
            ...
            <p>
                Аніме вже давно стало чимось більшим, ніж просто японська анімація. Для когось це улюблені персонажі та історії, для когось – музика, 
                атмосфера й емоції, які залишаються в пам’яті надовго.
            </p>
            <p className="mb-4">
            ...
            <ul className="list-disc pl-8 space-y-2 mb-2">
                ...
                <li>Додавати друзів, ділитися профілем та переглядати списки інших користувачів;</li>
            </ul>
