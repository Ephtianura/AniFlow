...
//     import { Anime, Genre, PagedResult, Studio, TitleLanguage } from "@/core/types";
...
//             setLoading(true);
//             try {
//                 const anime = await apiFetch<Anime>(`/anime/${id}`);
//                 selectAnimeFromSearch(anime);
//             } catch (err) {
//                 console.error(err);
//                 setErrors({ general: ["Не вдалося завантажити аніме."] });
//             } finally {
//                 setLoading(false);
//             }
//         };
