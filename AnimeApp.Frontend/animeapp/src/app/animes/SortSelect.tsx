...
export default function SortSelect({ sortBy, setSortBy }: any) {
    ...
    return (
        <div className="relative w-35 sm:w-44 ">
            <Listbox value={sortBy} onChange={setSortBy}>
                <ListboxButton
                    className="relative flex w-full items-center justify-between px-3 py-1.5 text-left text-primary-black shadow-sm rounded-xs border border-btn-border-light bg-white
