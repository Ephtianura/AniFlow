...
namespace AnimeApp.DataAccess.Migrations
{
    ...
    [Migration("20260706024338_change-titles-max-length-limits")]
    partial class changetitlesmaxlengthlimits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimeApp.Core.Models.UserFriend", b =>
                {
            ...
            modelBuilder.Entity("AnimeApp.Core.Models.UserFriend", b =>
                {
                    b.HasOne("AnimeApp.Core.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AnimeApp.Core.Models.User", "Sender")
                        .WithMany()
